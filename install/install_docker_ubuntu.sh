#!/bin/bash
# Script de instalação do Docker Engine para Ubuntu com verificação prévia
...
echo "=== Adicionando a chave GPG oficial do Docker (Ubuntu) ==="
...
echo "=== Instalação concluída com sucesso no Ubuntu! ==="
sudo docker --version
